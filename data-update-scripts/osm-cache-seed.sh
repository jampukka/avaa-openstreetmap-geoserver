...
do
 ...
 curl -s -u '<geoserver_user_name>:<geoserver_password>' -XPOST -H "Content-type: application/json"  \
     -d "{'seedRequest':{'zoomStart':1,'zoomStop':11,'minX':25472000,'maxX':25515000,'minY':6655000,'maxY':6699000,'format':'image\/png','threadCount':1}}}" \
